    ...
    if selected_cancer != "Select":
        ...
        if st.button("Get Information"):
            ...
            if cancer_instance:
                ...
                st.write(result)
                st.write("⚠Warning:Information above is a statistical information results and curing probabilities of various types of cancer may vary from person to person")
            else:
